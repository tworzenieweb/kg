			...
			<col width="5%" />
          	<thead>
            	<tr>
				   ...
				   <td align="center"><a href="javascript:columnsort('active');">Aktywny</a></td>
		  ...
		  <?php 		  	
		    ...
		    if ( is_array( $list_resoults ) ) { 
				foreach( $list_resoults as $object ) { 
						$pic_active      = ($object->active)?'<img src="../img/small/tick.png" title="Wpis potwierdzony" width="12" height="12" />':'<img src="../img/small/no-accept.gif" title="Wpis niepotwierdzony" width="12" height="12" />';
	...
	/* Adres email */	echo '  <td><a href="mailto:'.$object->email.'">'.$object->email.'</a></td>';	
	/* Aktywny */		echo '  <td align="center"><a href="javascript: void(0);" onclick="return listItemTask(\'cb'.$j.'\',\'change_active\')">'.$pic_active.'</a></td>';
