               ...
               <tr>
                 <td class="tb-find"><label>Filtruj</label>
                   <select name="filter" onchange="submitbutton('find');">
                     <option value="0" <?=($_POST['filter']=='0')?'selected="selected"':''?>>Wiadomo¶ci</option>
                     <option value="1" <?=($_POST['filter']=='1')?'selected="selected"':''?>>Wiadomo¶ci specjalne</option>
                     <option value="2" <?=($_POST['filter']=='2')?'selected="selected"':''?>>Wszystkie wiadomo¶ci </option>
                   </select>
                 </td>
			...
			<col width="5%"/>
          	<thead>
            	<tr>
				   ...
				   <td align="center"><a href="javascript:columnsort('b.id');">Info</a></td>
				   <td><a href="javascript:columnsort('title');">Tytu³</a></td>
                   <td><a href="javascript:columnsort('name');">Szablon</a></td>
				   <td align="center"><a href="javascript:columnsort('special');">Specjalna</a></td>
                   <td><a href="javascript:columnsort('create_date');">Utworzony</a></td>				   
				   <td><a href="javascript:columnsort('update_date');">Zmodyfikowany</a></td>
				   <td align="center">Podgl±d</a></td>
		  ...
		  <?php 		  	
		    ...
		    if ( is_array( $list_resoults ) ) { 
				foreach( $list_resoults as $object ) { 
						...
						$special = ($object->special)?'<img src="../img/small/special.png" title="Wiadomo¶æ specjalna" width="12" height="12" />':'<img src="../img/small/normal.png" title="Wiadomo¶æ" width="12" height="12" />';
						$delete = ($object->special)?'<img src="../img/small/no-accept.gif" title="Nie mo¿na usun±æ wiadomo¶ci specjalnej" width="12" height="12" />':'<a href="javascript: void(0);" onclick="return listItemTask(\'cb'.$j.'\',\'delete\')"><img src="../img/small/publish_x.png" title="Usuñ" width="12" height="12" /></a>';
						echo '<tr class="row'.$i.'">';
						...
						echo '  <td>'.$object->create_date.'</td>';
						echo '  <td>'.$object->update_date.'</td>'; 
						echo '  <td align="center"><a href="javascript: void(0);" onclick="openwindow(\'mail_template_view.php?message_id='.$object->id.'&template_id='.$object->template_id.'\');"><img src="../img/small/preview.png" title="Podgl±d" width="16" height="16" /></a></td>';
						echo '  <td align="center"><a href="?navigate=messagemail&action=edit&id='.$object->id.'"><img src="../img/small/edit.png" title="Edytuj" width="16" height="16" /></a></td>';
